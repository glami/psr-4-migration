...
$robotLoader->addDirectory(__DIR__ . '/../../app')
...
foreach ($uniqueFiles as $absoluteFilePath) {
    $pathAfterApp = \Klarka\Utils\TypeSafeNetteStrings::after($absoluteFilePath, '../app/');
    $file = sprintf('/project/app/%s', $pathAfterApp);

    $cmd = "docker run -v $(pwd):/project rector-glami process --autoload-file /project/vendor/autoload.php --config /project/config/rector/psr-4-classes-split.yaml $file";
    echo "$cmd\n";
    echo shell_exec($cmd);
    echo "\n";
