...
\Nette\Utils\FileSystem::write(__DIR__ . '/../../config/rector/rename_classmap_model.yaml', Yaml::dump($rectorConfig, 10));
...
function computeClassName(string $classPath, string $pathToProcess): string
{
    ...
    return 'Klarka\\App\\' . $classWithoutPrefix;
}